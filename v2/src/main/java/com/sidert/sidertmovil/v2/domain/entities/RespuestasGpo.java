...
@Entity(tableName = "respuestas_gpo_t")
public final class RespuestasGpo implements Serializable {
    ...
    @ColumnInfo(name = "motivo_aclaracion")
    private String motivoAclaracion;
    ...
    @ColumnInfo(name = "detalle_ficha")
    private String detalleFicha;
    ...
    @ColumnInfo(name = "arqueo_caja",defaultValue="'0'")
...
// Getters & Setters
    ...
    public String getMotivoAclaracion(){
        return this.motivoAclaracion;
    }

    public void setMotivoAclaracion(String motivoAclaracion){
    ...
    public String getDetalleFicha(){
        return this.detalleFicha;
    }

    public void setDetalleFicha(String detalleFicha){
