...
public class datoCampana extends BaseModel implements Serializable, IFillModel {

    public static final String  TBL               = "tbl_datos_credito_campana";
    public static final String  COL_ID_SOLICITUD  = "id_solicitu1d";
    public static final String  COL_ID_ORIGINACION= "id_originacion";
    public static final String  COL_ID_CAMPANA       = "id_campana";
    public static final String  COL_TIPO_CAMPANA  = "tipo_camapan";
