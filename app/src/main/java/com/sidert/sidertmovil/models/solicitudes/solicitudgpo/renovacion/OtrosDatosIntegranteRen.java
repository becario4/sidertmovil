...
public class OtrosDatosIntegranteRen extends BaseModel implements Serializable, IFillModel {
    public final static String TBL                         = "tbl_otros_datos_integrante_ren";
