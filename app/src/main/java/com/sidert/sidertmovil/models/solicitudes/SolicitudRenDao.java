...
public class SolicitudRenDao {
    ...
    public void solicitudEnviada(SolicitudRen solicitudRen) {
        ...
        if (solicitudRen.getIdOriginacion() > 0){
            cv.put("id_originacion", String.valueOf(solicitudRen.getIdOriginacion()));
        }
        ...
        db.update(TBL_DATOS_BENEFICIARIO_REN, mn, "id_solicitud = ?", new String[]{String.valueOf(solicitudRen.getIdSolicitud())});
