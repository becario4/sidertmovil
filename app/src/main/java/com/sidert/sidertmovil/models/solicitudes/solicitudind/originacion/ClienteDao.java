...
public class ClienteDao {
    ...
    public Cliente findByIdSolicitud(Integer idSolicitud)
    {
        Cliente cliente = null;
    ...
    public void updateEstatus(Cliente cliente)
    {
        ContentValues cv = new ContentValues();

        cv.put("comentario_rechazo", cliente.getComentarioRechazo());
        db.update(TBL_CLIENTE_IND, cv, "id_cliente = ?", new String[]{String.valueOf(cliente.getIdCliente())});
    }

    private void Fill(Cursor row, Cliente cliente)
    {
