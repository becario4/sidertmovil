...
public class BeneficiarioRen extends BaseModel implements Serializable, IFillModel {

public static final String TBL                        = "tbl_datos_beneficiario_ind_ren";
public static final String COL_ID_BENEFICIARIO        = "idBeneficiario";
public static final String COL_ID_SOLICITUD           = "id_solicitud";
public static final String COL_ID_ORIGINACION         = "id_originacion"; /** ID_ORIGINACION = SOLICITANTE_ID*/
