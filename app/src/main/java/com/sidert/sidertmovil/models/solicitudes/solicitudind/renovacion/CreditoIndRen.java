...
public class CreditoIndRen extends BaseModel implements Serializable, IFillModel {
    public final static String TBL                         = "tbl_credito_ind_ren";
    ...
    protected static final String COL_CREDITO_ANTERIOR     = "credito_anterior";
    protected static final String COL_COMPORTAMIENTO_PAGO  = "comportamiento_pago";
    protected static final String COL_NUM_CLIENTE          = "num_cliente";
    ...
    @SerializedName(COL_CREDITO_ANTERIOR)
    @Expose
    private String creditoAnterior;

    @SerializedName(COL_COMPORTAMIENTO_PAGO)
    @Expose
    private String comportamientoPago;

    @SerializedName(COL_NUM_CLIENTE)
    @Expose
    ...
    public void fill(Cursor row) {
        ...
        creditoAnterior     = getString(COL_CREDITO_ANTERIOR);
        comportamientoPago  = getString(COL_COMPORTAMIENTO_PAGO);
        numCliente          = getString(COL_NUM_CLIENTE);
