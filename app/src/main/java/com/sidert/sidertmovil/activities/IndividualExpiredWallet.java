...
import com.sidert.sidertmovil.fragments.view_pager.ind_experid_wallet_fragment;
import com.sidert.sidertmovil.fragments.view_pager.ind_expired_wallet_management;
...
public class IndividualExpiredWallet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_individual_expired_wallet);
    ...
    private void setUpViewPager() {
        ...
        adapter.addFragment(new ind_experid_wallet_fragment(), "");
        adapter.addFragment(new ind_expired_wallet_management(), "");
