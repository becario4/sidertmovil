...
public class adapter_ficha_ruta extends RecyclerView.Adapter<adapter_ficha_ruta.ViewHolder> {
    ...
    public adapter_ficha_ruta(Context ctx, List<MCarteraGnral> data, Event evento) {
        this.ctx = ctx;
        this.data = data;
        this.evento = evento;
    }
