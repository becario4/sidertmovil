...
public class adapter_pagos_clientes extends RecyclerView.Adapter<adapter_pagos_clientes.ViewHolder> {

    private Context ctx;
    private List<ModeloIndividual.TablaPagosCliente> data;

    public adapter_pagos_clientes(Context ctx, List<ModeloIndividual.TablaPagosCliente> data) {
        this.ctx = ctx;
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(ctx).inflate(R.layout.item_pagos_cliente, parent, false);
